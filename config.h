 ...
 */
static char font[] = "Fira Code Medium:pixelsize=13:antialias=true:hinting=full";
//static char font[] = "Fira Code Medium:size=12";
//static char font[] = "Inconsolata:dpi=90:pixelsize=22:antialias=true:hinting=full";
//static char font[] = "Inconsolata:pixelsize=14:antialias=true:hinting=full";
...
static Shortcut shortcuts[] = {
	...
	{ MODKEY|ShiftMask,     XK_Page_Up,     xzoom,          {.f = +1} },
	{ MODKEY|ShiftMask,     XK_Page_Down,   xzoom,          {.f = -1} },
